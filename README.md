...
Учебный проект, выполненный при обучении автотестированию. На небольших Java-методах показаны подбор тестовых данных, параметризация, проверка исключений, управление порядком выполнения и объединение тестов в сьюты. Похожие сценарии реализованы на JUnit 5 и TestNG, чтобы сравнить подходы двух фреймворков.
