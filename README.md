...
Учебный проект Александра, выполненный при обучении автотестированию в «Школе 21». На небольших Java-методах показаны подбор тестовых данных, параметризация, проверка исключений, управление порядком выполнения и объединение тестов в сьюты. Похожие сценарии реализованы на JUnit 5 и TestNG, чтобы сравнить подходы двух фреймворков.
...
Тесты и доработки выполнены Александром на основе учебного Java-каркаса. Часть примеров методов и структуры была предоставлена в рамках обучения; проект не выдаётся за приложение, написанное с нуля. При подборе части данных и формулировок использовался ИИ с последующим ручным отбором.
